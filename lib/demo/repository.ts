...
const fixtureGlobal = globalThis as typeof globalThis & {
  __marketvalleyFixtureCampaignRepositoryV2?: FixtureCampaignRepository;
};

export const fixtureCampaignRepository =
  fixtureGlobal.__marketvalleyFixtureCampaignRepositoryV2
  ?? new FixtureCampaignRepository({ reuseDemoCampaign: true });

fixtureGlobal.__marketvalleyFixtureCampaignRepositoryV2 = fixtureCampaignRepository;
