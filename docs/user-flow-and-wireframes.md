...
1. 메인 웹사이트의 입력·캠페인 결과 desktop·375px 프레임
...
Figma의 예약·이메일 수집 표현은 개인정보 없는 선택형 응답이라는 제품 계약과 충돌해 사용하지 않았다. 화면 상태, 색상, 타이포그래피와 진행·리포트 구조는 Figma를 따르고, 공개 캠페인은 같은 `CampaignSpec`의 결정적 렌더러로 구성했다.
