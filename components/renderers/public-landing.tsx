  ...
  return (
    <div className="public-landing">
      <header className="landing-header">
        <a className="landing-brand" href="#top"><span>마감</span>한입</a>
      ...
      <main id="top">
        <section className="landing-hero">
          ...
          <div className="landing-hero-art" aria-hidden="true">
            <div className="menu-card one"><span>오늘의 마감 메뉴</span><strong>레몬 케이크</strong><b>3개 남음</b></div>
            <div className="menu-card two"><span>동네 이웃의 신호</span><strong>오늘 들를게요</strong><b>익명 응답</b></div>
            <div className="hero-curve" />
          </div>
        </section>

        <section className="landing-problem landing-section">
          <span className="landing-kicker">CLOSING-TIME ROUTINE</span>
          <h2>마감 때마다<br />이런 일을 반복하셨나요?</h2>
        ...
        <section className="landing-statement">
          <span>검증보다 제작이 먼저 쌓이지 않도록</span>
          <h2>남은 메뉴 한 번만 입력하세요.<br /><mark>알림 제작과 반응 정리는 사라집니다.</mark></h2>
        </section>
        ...
        <section id="signal" className="signal-panel">
          ...
          <div className="signal-form">
            {submitted ? (
              <div className="signal-success"><span><CheckIcon size={28} /></span><h3>응답이 기록됐어요</h3><p>{spec.validation.signal.successMessage}</p><a href="/campaigns/demo">데모 리포트에서 확인하기</a></div>
            ) : duplicate ? (
              <div className="signal-success duplicate"><span><CheckIcon size={28} /></span><h3>이미 참여했어요</h3><p>최초 응답을 유지하고 중복으로 집계하지 않았습니다.</p><a href="/campaigns/demo">데모 리포트 보기</a></div>
            ) : (
              <>
      ...
      <footer className="landing-footer"><strong>마감한입</strong><p>이 페이지는 marketvalley로 만든 발표용 목캠페인입니다.</p><a href="/">Made with marketvalley</a></footer>
    </div>
  );
}
